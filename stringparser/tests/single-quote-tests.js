...
describe('Single Quote String Parse Tests', function () {
    ...
    it('can validate basic single quote string', function() {
        var test = "'a'";
        parser.validateString(test).should.be.true;// equal(true);
    });

    it('identifies missing closing single quote', function() {
        var test = "'a";
        parser.validateString(test).should.be.false;
    });

    it('identifies missing opening single quote', function() {
        var test = "a'";
        parser.validateString(test).should.be.false;
    });
