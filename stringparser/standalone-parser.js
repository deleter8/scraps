module.exports = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c3 = [],
        peg$c4 = function(values) {return values.join('');},
        peg$c5 = "'",
    ...
    function peg$parseescape_dbl() {
      var s0;

      s0 = peg$parseescape_sequence();
      if (s0 === peg$FAILED) {
        s0 = peg$parsechar_dbl_quote();
      }

      return s0;
    }

    function peg$parseescape_single() {
      var s0;

      s0 = peg$parseescape_sequence();
      if (s0 === peg$FAILED) {
        s0 = peg$parsechar_single_quote();
      }
    ...
    function peg$parsechar_dbl_quote() {
      var s0;
